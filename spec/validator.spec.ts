...
Paste a trial object returned from the matching service API into trial_object.json . This will check if the conversion to a researchStudy is being made properly
